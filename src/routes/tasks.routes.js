...
router.get('/historiaclinicausuario', getHistoriaClinicaUsuario);

router.get('/historiaclinicausuarioindividual/:id', getHistoriaClinicaUsuarioIndividual);


router.get('/verturnosmedico/:id', getTurnosMedico);

router.get('/usuarioindividual/:id', getUsuarioIndividual);

router.get('/turnopaciente/:id', getPacienteTurno);

router.post('/agregarhistorialclinico/:id', agregarHistorialClinico);
